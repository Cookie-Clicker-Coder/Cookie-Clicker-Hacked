...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.cookieClicks=100000000000000000000000000000000000000;//+1 for each click on the cookie
		Game.goldenClicks=100000000000000000000000000000000000000;//+1 for each golden cookie clicked (all time)
		...
		Game.lumps=100003283734312983416564452;//sugar lumps
		Game.lumpsTotal=9853798719893897489123746723999;//sugar lumps earned across all playthroughs (-1 means they haven't even started yet)
